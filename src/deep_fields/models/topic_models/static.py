...
class DiscreteLatentTopicNVI(DeepBayesianModel):
    ...
    def set_parameters(self, **kwargs):
        ...
        self.theta_size = self.theta_q_param.get("hidden_state_dim")
    ...
    def define_deep_models(self):
        ...
        if not self.no_topics:
            self.topic_prop_transform = nn.Sequential(nn.Linear(self.theta_size, self.number_of_topics), nn.Softmax(dim=1))
